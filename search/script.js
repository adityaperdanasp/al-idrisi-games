...
const INDEX = [
  ...
  ["✨", "Workshop", "../workshop/", "Gold and Holo upgrades", "workshop upgrade gold holo tier efek effect theme costume ammo"],
  ["🦖", "Dino Rider", "../dino-rider/", "Ride an evolving dino", "dino rider dinosaur evolve naik dinosaurus"],
  ["⛵", "Sea Mission", "../sea-mission/", "Boat cannon game", "sea mission boat kapal laut monster cannon"],
