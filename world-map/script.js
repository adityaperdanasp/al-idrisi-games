...
const REGIONS = [
  ...
  { name: "Adventure Isle", emoji: "🏝️", bg: "linear-gradient(160deg,#fce7f3,#f9a8d4)", nodes: [
    ["island-adventure", "🏝️", "Island Adventure", "../island-adventure/", "island-adventure"], ["dungeon", "🗡️", "Dungeon Crawler", "../dungeon/", "dungeon"], ["escape-daily", "🗝️", "Escape Room", "../escape-daily/", "escape-daily"],
